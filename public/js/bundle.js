...
var displayMap = function displayMap(locationData) {
  var startLocation = locationData[0].coordinates;
  var map = L.map('map').setView([startLocation[1], startLocation[0]], 8);
  L.marker([startLocation[1], startLocation[0]]).addTo(map);
  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
    maxZoom: 19,
    attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
  }).addTo(map);
  var locationCoords = locationData[1];
  locationCoords.forEach(function (el, i) {
    var coords = el.coordinates;
    L.popup().setLatLng([coords[1], coords[0]]).setContent("Day ".concat(i + 1, " : ").concat(el.description)).addTo(map);
  });
};
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          (0, _alerts.showAlert)('success', 'Welcome to Natours! You will be transfer to personal page shortly');
          window.setTimeout(function () {
            location.assign('/me');
          }, 1500);
          _context3.next = 13;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51N1PBAIq5PvrzIVYO5l0JOUPBovheTfXjrwNCMtBfOVsHd0tKrTWZcvSwZzBldttQuTXrzEIUddZRyQSa1EXiD8s00iQ8im3UH');
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var data, _yield$data$json, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 6:
          ...
          session = _yield$data$json.session;
          console.log(session);
        ...
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('payment error:', _context.t0);
        case 16:
        case "end":
          return _context.stop();
      }
...
if (mapBox) {
  var locationData = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(locationData);
}
if (loginForm) {
...
if (signupForm) {
  document.querySelector('.form').addEventListener('submit', function (e) {
    e.preventDefault();
    var signupBtn = document.querySelector('.nav__el--signup');
